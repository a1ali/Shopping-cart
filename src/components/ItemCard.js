...
const ItemCard = ({ itemImg, itemTitle, itemPrice }) => {
    return (
        <div className="w-36 md:w-80 md:h-96 m-4 flex flex-col rounded-sm pt-4 border border-opacity-50 cursor-pointer overflow-hidden shadow-md transform hover:scale-95 ease-in duration-150">
            <img
                src={itemImg}
                alt=""
                className="w-full md:h-3/4 mb-2 p-4  object-contain"
            ></img>
