    ...
    return (
        <div className="font-roboto">
            ...
            {cart.length === 0 ? (
                ...
                cart.map((item) => (
                    <div key={item.id} className="relative mx-4 my-6 md:mx-20 flex items-center border p-2 divide-x-2 divide-gray-300 divide-opacity-50 rounded-sm  hover:shadow-md border-opacity-50 transform duration-200 ease-in">
                        <Link
